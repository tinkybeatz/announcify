...
export function UserDropdownBlue({
  userLabel,
  userEmail,
}: UserDropdownProps) {
  ...
  return (
    <div className="relative flex items-center h-full" ref={dropdownRef}>
      <button
        ...
        className="bg-sky-400/50 backdrop-blur-md flex items-center text-main-black font-bold justify-center rounded-xl h-full w-full px-4"
      >
      ...
      {isOpen && (
        <div className="absolute top-full font-rethink right-0 mt-3 bg-sky-400/50 backdrop-blur-md rounded-xl overflow-hidden w-52">
